    ...
    public partial class frm_StockReport : Form
    {
        ...
        private void textBox2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (char.IsLetter(e.KeyChar) || char.IsNumber(e.KeyChar) || e.KeyChar == ' ' || Convert.ToInt32(e.KeyChar) == 13)
            {
                ...
                strCombo = "SELECT distinct '<u>' AS Marka FROM tblstock Union all select distinct [Marka] from tblStock  order by marka";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                gg.StockReportMarkaWise(dateTimePicker1.Value, dateTimePicker2.Value, textBox1.Text, textBox2.Text, "StockMarkWise");
                gg.Show();
